 ...
 *  own `?view=`/`?state=` variants — Cluster #1 · Team-1 F2) and the `exactPath` opt-in (a
 *  parent-path item like "Company Profile" `/sell/company` never lights on sub-path siblings —
 *  DS-NAV). */
function isActive(
  pathname: string,
  search: string,
