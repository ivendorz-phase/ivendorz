...
export function DashboardHeaderCard({ userName, orgName }: { userName: string; orgName: string }) {
  return (
    <div className="overflow-hidden rounded-lg border border-border bg-card shadow-iv-xs">
      <div className="flex flex-wrap items-center gap-3 border-b border-border p-4 sm:p-5">
        ...
        <Link
          ...
          className="flex min-w-0 flex-1 items-center gap-2 rounded-md border border-input bg-background px-3 py-1.5 text-sm text-muted-foreground shadow-iv-xs transition-colors duration-normal ease-iv-out hover:bg-accent hover:text-foreground sm:max-w-xs"
        >
        ...
        <div className="ml-auto flex items-center gap-1">
          <Link
            ...
            className="inline-flex size-9 items-center justify-center rounded-md text-foreground transition-colors duration-normal ease-iv-out hover:bg-accent"
          >
          ...
          <Link
            ...
            className="inline-flex size-9 items-center justify-center rounded-full transition-colors duration-normal ease-iv-out hover:bg-accent"
          >
      ...
      <div className="min-w-0 p-4 sm:p-5">
        <p className="text-xl font-semibold tracking-tight text-iv-ink-heading">Good Morning</p>
