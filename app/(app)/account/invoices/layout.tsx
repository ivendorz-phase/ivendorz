// Platform invoices layout (Surface E · Doc-7E · P-ACC-20) — mounts the CANONICAL Platform Shell for this
// Account & Identity page, scoped to `/account/invoices` (and deeper) ONLY. App Router composition only.
//
...
export default function PlatformInvoicesLayout({ children }: { children: ReactNode }) {
