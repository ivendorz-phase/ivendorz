// Workflow settings layout (Surface E · Doc-7E · P-ACC-13) — mounts the CANONICAL Platform Shell for this
// Account & Identity page, scoped to `/account/settings` (and deeper) ONLY. App Router composition only.
//
...
// nav model (single source; the "Workflow" nav item points here).
...
const ACCOUNT_SHELL_VM: ShellViewModel = {
  ...
  breadcrumb: [{ label: "Account", href: "/account/overview" }, { label: "Workflow" }],
};

export default function WorkflowSettingsLayout({ children }: { children: ReactNode }) {
