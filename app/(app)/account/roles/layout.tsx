// Roles layout (Surface E · Doc-7E · P-ACC-08) — mounts the CANONICAL Platform Shell for this Account &
// Identity page, scoped to `/account/roles` (and deeper) ONLY. App Router composition only.
//
...
const ACCOUNT_SHELL_VM: ShellViewModel = {
  ...
  breadcrumb: [{ label: "Account", href: "/account/overview" }, { label: "Roles" }],
};
