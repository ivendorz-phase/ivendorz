// Delegation layout (Surface E · Doc-7E · P-ACC-11) — mounts the CANONICAL Platform Shell for this
// Account & Identity page, scoped to `/account/delegation` (and deeper) ONLY. App Router composition only.
//
...
const ACCOUNT_SHELL_VM: ShellViewModel = {
  ...
  breadcrumb: [{ label: "Account", href: "/account/overview" }, { label: "Delegation" }],
};
