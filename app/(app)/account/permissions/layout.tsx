// Permissions reference layout (Surface E · Doc-7E · P-ACC-10) — mounts the CANONICAL Platform Shell for
// this Account & Identity page, scoped to `/account/permissions` ONLY. App Router composition only.
//
...
// nav model (single source). Breadcrumb links back to Roles (permissions are assigned through roles).
...
const ACCOUNT_SHELL_VM: ShellViewModel = {
  ...
  breadcrumb: [
    ...
    { label: "Roles", href: "/account/roles" },
    { label: "Permissions" },
  ],
};
