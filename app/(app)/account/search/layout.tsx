...
// the account/shell area at `/account/search` and reuses the shared Account shell view-model
// (least-invention; no nav model coined). Doc-7C may ultimately place it elsewhere — recorded as
