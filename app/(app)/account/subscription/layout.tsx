// Subscription layout (Surface E · Doc-7E · P-ACC-17) — mounts the CANONICAL Platform Shell for this
// Account & Identity page, scoped to `/account/subscription` ONLY. App Router composition only.
//
