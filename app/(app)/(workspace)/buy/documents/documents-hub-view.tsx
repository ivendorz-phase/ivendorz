  ...
  },
  {
    ...
    render: (g) =>
      g.sourceEngagementId ? (
        <Link
          href={`/buy/engagements/${g.sourceEngagementId}`}
  ...
  const all: (RelatedDocumentLink & { stageKey?: DocumentStageKey })[] = [
    {
      id: "loi",
      label: "LOI",
      href: `/buy/engagements/${e.id}/loi`,
      kindKey: "loi",
    },
    {
      id: "po",
      label: "Purchase order",
      href: `/buy/engagements/${e.id}/po`,
      kindKey: "po",
      stageKey: "po",
    },
    {
      id: "challan",
      label: "Challan",
      href: `/buy/engagements/${e.id}/challan`,
      kindKey: "challan",
      stageKey: "challan",
    },
    {
      id: "invoice",
      label: "Trade invoice",
      href: `/buy/engagements/${e.id}/trade-invoice`,
    ...
    },
    {
      id: "payments",
      label: "Payments",
      href: `/buy/engagements/${e.id}/payments`,
      kindKey: "payment_record",
      stageKey: "payment",
    },
    { id: "wcc", label: "WCC", href: `/buy/engagements/${e.id}/wcc`, kindKey: "wcc" },
  ];
    ...
    <nav aria-label="Filter documents by view" className="flex flex-wrap items-center gap-2">
      {VIEW_CHIPS.map((chip) => {
        ...
        return (
          ...
          >
            <Link href={isAll ? "/buy/documents" : `/buy/documents?view=${chip.key}`}>
              {chip.label}
            </Link>
          </Button>
        );
...
export function DocumentsHubView({ data }: { data: DocumentsHubData }) {
  ...
  const clearFilters = (
    <Button asChild variant="secondary" size="sm">
      <Link href="/buy/documents">Clear filters</Link>
    </Button>
  );
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-4">
            ...
            >
                ...
                <div className="flex flex-col gap-3">
                  {data.pendingInvoices.length === 0 ? (
                    ...
                    <DataListTable
                      ...
                      getRowHref={(p) => `/buy/engagements/${p.engagementId}/trade-invoice`}
              ...
              {activeView === "completed" ? (
                <p className="mt-3 text-xs text-muted-foreground">
                  ...
                  <Link
                    href="/buy/engagements?status=completed"
            ...
            >
              <DocumentRelations
                ...
                links={[
                  { id: "rfqs", label: "RFQs", href: "/buy/rfqs", kindKey: "rfq" },
                  {
                    id: "approvals",
