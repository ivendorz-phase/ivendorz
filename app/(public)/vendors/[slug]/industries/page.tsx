...
// /industries page. This URL is a thin redirect to the home-page section anchor (owner-approved
// single-page model). No multi-page architecture is invented; an unknown vendor 404s on the canonical
// /vendors/[slug] page.
export default async function VendorIndustriesStub({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  const { slug } = await params;
  redirect(`/vendors/${slug}#industries`);
}
