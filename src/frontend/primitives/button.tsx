...
const buttonVariants = cva(
  // Motion Standard: tokenized 150ms easeOut micro-interaction (colors/shadow/filter now
  // transition together instead of the filter snapping) + subtle tap feedback via a GPU
  // transform. CSS, not Framer Motion — this primitive stays server-render-friendly.
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-[color,background-color,border-color,box-shadow,filter,transform,opacity] duration-150 ease-iv-out active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
