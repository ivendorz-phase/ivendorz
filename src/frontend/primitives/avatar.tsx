...
// Primitive: Avatar (Doc-7B BR2 — Radix-vendored). Presentation-only; renders an image the
// surface supplies by prop (a `file_ref`-resolved URL), with an initials fallback.
