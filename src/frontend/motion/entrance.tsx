...
export interface FadeInProps {
  ...
  className?: string;
  /** Extra entrance delay in seconds — keep ≤ 0.2 (Motion Standard §4.4). */
  delay?: number;
}
...
/** Parent for a staggered entrance — wrap each child in `StaggerItem`. */
...
/** One staggered child — inherits timing from the parent `Stagger`. */
