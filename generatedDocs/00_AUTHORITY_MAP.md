...
| `Doc-5A_SERIES_FROZEN_v1.0.md` (API Realization Standards) | FROZEN — pending ratification | v1.0 | ✅ | API realization metastandard; effective = Pass-1…12 + patches (`STRUCT-02`, `0-D`, `D4A-C05-204`); gates Doc-5B…5M via Appendix A |
