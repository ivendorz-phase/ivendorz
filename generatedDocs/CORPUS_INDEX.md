...
- **Authoritative:** `Doc-2_Domain_Model_And_Database_Blueprint_v1.0.2.md` + patches `Doc2_Patch_v1.0.2.md`, `Doc-2_Patch_v1.0.3.md`, `Doc-2_Patch_v1.0.4.md` (BuyerProfileAudit — business-action semantics only; linked pair `Doc-4C_BuyerProfileAuditToken_Patch_v1.0.2.md`), `Doc-2_Patch_v1.0.5.md` (VendorSubdomainSlug / PATCH-D2-04, ADR-024; linked set `Doc-4D_CanonicalHost_Patch_v1.0.2.md` + `Doc-6D_VendorSlugSubdomain_Patch_v1.0.1.md` + `Doc-3_Policy_Key_Registration_Patch_v1.10_VendorSubdomain.md`), `Doc-2_Patch_v1.0.6.md` (PATCH-D2-05, `identity.users.display_name`; linked pair `Doc-6C_Patch_v1.0.2.md`), `Doc-2_Patch_v1.0.7.md` (PATCH-D2-06, §5.10 suspended-at-expiry boundary; `[ESC-IDN-DELEG-EXPIRY]` cleared; companion `Doc-4M_Patch_v1.0.2.md`), `Doc-2_Patch_v1.0.8.md` (PATCH-D2-07, §7 routing-governance staff slugs; `[ESC-RFQ-SLUG]` cleared; companion `Doc-6C_Patch_v1.0.3.md`) — all human/Board-approved, additive, carried alongside the unedited frozen base (effective v1.0.8)

**Doc-3 — RFQ Procurement Engine & Operational Specification**
- **Authoritative:** `Doc-3_RFQ_Procurement_Engine_And_Operational_Specification_v1.0.1.md` + patches `Doc-3_Patch_v1.0.2.md`, `Doc-3_Policy_Key_Registration_Patch_v1.0.md` (`core.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.1_RFQ.md` (`rfq.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.2_Marketplace.md` (`marketplace.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.3_Trust.md` (`trust.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.4_Operations.md` (`operations.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.5_Communication.md` (`communication.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.6_Billing.md` (`billing.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.7_Admin.md` (`admin.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.8_AI.md` (`ai.*` keys), `Doc-3_Policy_Key_Registration_Patch_v1.10_VendorSubdomain.md` (one `marketplace.*` key — reserved vendor-subdomain labels; ADR-024; folded 2026-07-03), `Doc-3_Policy_Key_Registration_Patch_v1.11_PublicReadRateLimit.md` (`marketplace.public_read_rate_limit`, folded 2026-07-03 with the `ESC-7-API-PRODDETAIL` E-1/E-3 pair — see 00_AUTHORITY_MAP.md), `Doc-3_Policy_Key_Registration_Patch_v1.12_FairnessShareWindow.md` (`fairness.share_window_days`, owner-ruled 2026-07-15; full registration list per 00_AUTHORITY_MAP.md, this index is not exhaustively kept in step) (effective v1.0.2)
