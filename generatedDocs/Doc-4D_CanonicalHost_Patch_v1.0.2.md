...
> Origin/provenance: `governanceReviews/Doc-4D_CanonicalHost_Additive_Patch_PROPOSAL.md`. **Linked set** with `Doc-2_Patch_v1.0.5` (PATCH-D2-04, the business
