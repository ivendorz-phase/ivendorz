# Doc-4I_PassB_Part2_v1.0_FROZEN — Billing / Monetization — Pass-B Part 2 (BC-BILL-4/5/6) — FROZEN Consolidation

| Freeze Metadata | Value |
|---|---|
| Status | **FROZEN** |
| Source | `Doc-4I_PassB_Part2_BC-BILL-4_5_6_v1.0` (base body, byte-faithful) |
| Amendment | `Doc-4I_PassB_Part2_Patch_v1.0` (F4I-PB2-M1, F4I-PB2-M2, F4I-PB2-N1 — applied inline) |
| Freeze Authority | `Doc-4I_PassB_Part2_Freeze_Audit_v1.0` (FREEZE APPROVED · BLOCKER=0 · MAJOR=0 · MINOR=0 · NITPICK=0) |
...
| Freeze References | Architecture · ADR · Doc-2 v1.0.3 · Doc-3 v1.0.2 · Doc-4A–4H (FROZEN) · `Doc-4I_Structure_v1.0` (FROZEN) · `Doc-4I_PassA_Content_v1.0` (FROZEN) · `Doc-4I_PassB_Part1_v1.0_FROZEN` (BC-BILL-1/2/3) |
| Part scope | **BC-BILL-4 Lead Credits · BC-BILL-5 Platform Invoicing & Payments · BC-BILL-6 Rewards & Referrals** — 14 contract-IDs (BC-BILL-4: 4 · BC-BILL-5: 5 · BC-BILL-6: 5). |
| Sole authority for downstream | This frozen document (BC-BILL-4/5/6 Pass-B). Not revisited, not redesigned, not reopened. |
| Conflict rule | FLAG-AND-HALT (no local resolution). |

> **Mechanical-merge note.** This FROZEN document is the byte-faithful base body of `Doc-4I_PassB_Part2_BC-BILL-4_5_6_v1.0` with the three accepted findings of `Doc-4I_PassB_Part2_Patch_v1.0` folded inline at §HB-5.2 (Stage-7 + Section 9 Audit) and §HB-6.2 (Stage-3 + Stage-7). No contract, aggregate, state, transition, slug, event, audit action, POLICY key, or template was created or changed. Review/finding/draft commentary is not carried.
...
## Freeze Certificate — Doc-4I_PassB_Part2_v1.0_FROZEN

```text
Document        : Doc-4I_PassB_Part2_v1.0_FROZEN
Module          : 7 — Billing / Monetization  (schema `billing`, namespace `billing_`)
Part            : Pass-B Part 2 — BC-BILL-4 / BC-BILL-5 / BC-BILL-6
Source body     : Doc-4I_PassB_Part2_BC-BILL-4_5_6_v1.0  (byte-faithful)
Folded patch    : Doc-4I_PassB_Part2_Patch_v1.0  (F4I-PB2-M1, F4I-PB2-M2, F4I-PB2-N1 — CLOSED)
Freeze authority: Doc-4I_PassB_Part2_Freeze_Audit_v1.0  (FREEZE APPROVED)
Open findings   : BLOCKER = 0 · MAJOR = 0 · MINOR = 0 · NITPICK = 0
Contract-IDs    : 14  (BC-BILL-4: 4 · BC-BILL-5: 5 · BC-BILL-6: 5)
Invariants held : disjoint ownership (Lead Credit Account / Platform Invoice / Reward Account);
                  billing.platform_invoices ≠ operations.trade_invoices (FIXED);
                  these BCs emit no Doc-2 §8 event; procurement moat held; trust firewall held;
                  nothing invented (no entity/state/event/slug/audit-action/POLICY-key/template).
Status          : FROZEN — 2026-06-19
```

*End of Doc-4I_PassB_Part2_v1.0_FROZEN. Mechanical merge only (base body + patch folded inline); no redesign. This frozen Part is consumed by the Module-7 Consolidation Review and the Doc-4I Final Freeze Audit. Any change requires Architecture Board approval (Doc-4_Governance_Note_v1.0).*
