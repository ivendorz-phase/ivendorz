...
| Frontend design companions (non-authoritative — supplement Doc-7, never override it) | `docs/frontend/design-system/design_philosophy.md` · `docs/product/information-architecture/information_architecture.md` · `docs/product/ux/ux_patterns.md` · `docs/product/ux/marketplace_ux.md` · `docs/product/ux/page_inventory.md` · `docs/frontend/design-system/page_templates.md` · `docs/product/ux/screen_specifications.md` · `docs/product/ux/landing_page_spec.md` · `docs/frontend/components/shared_conventions.md` · `esc_registry.md` · `docs/reference/glossary.md` · `docs/reference/deferred_decisions.md` · `docs/frontend/architecture/visual_reference_implementation.md` (see `docs/INDEX.md` for the full map). **First FE slice** (Public/Doc-7D, **Wave 3** with M2): `project-management/frontend_first_slice.md` |
