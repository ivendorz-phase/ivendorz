...
**Companions:** [`shared_conventions.md`](../../frontend/components/shared_conventions.md) (`SC`) · [`esc_registry.md`](../../../esc_registry.md) (`ER`) · [`glossary.md`](../../reference/glossary.md) (`GL`) · [`design_philosophy.md`](../../frontend/design-system/design_philosophy.md) (`DP`) · [`page_templates.md`](../../frontend/design-system/page_templates.md) (`PT`) · [`information_architecture.md`](../information-architecture/information_architecture.md) (`IA`) · [`ux_patterns.md`](ux_patterns.md) (`UX`) · [`marketplace_ux.md`](marketplace_ux.md) (`MX`) · [`page_inventory.md`](page_inventory.md) (`PI`)
