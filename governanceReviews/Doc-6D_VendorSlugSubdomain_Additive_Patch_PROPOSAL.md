# Doc-6D_VendorSlugSubdomain_Additive_Patch_PROPOSAL.md

> **✅ STATUS: APPROVED (human — owner/Board ruling 2026-07-03; artifact text gate-confirmed same day) + FOLDED into the corpus.**
> Corpus copy: `generatedDocs/Doc-6D_VendorSlugSubdomain_Patch_v1.0.1.md`,
> registered in `00_AUTHORITY_MAP.md`, carried **alongside** the unedited frozen Doc-6D passes — **no frozen
> file edited in place.** This file stays the provenance copy. **Linked set** with `Doc-2_Patch_v1.0.5` (PATCH-D2-04, the business semantics this
