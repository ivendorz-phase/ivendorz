...
> `generatedDocs/Doc-4C_BuyerProfileAuditToken_Patch_v1.0.2.md` (registered in `00_AUTHORITY_MAP.md`). Retained
> here as provenance; the corpus copy is authoritative.

> **✅ STATUS: DRAFT — PROPOSED ADDITIVE PATCH; AWAITS HUMAN APPROVAL.** Doc-4C is part of the **frozen
> Doc-4 series (rank-0 corpus)** — immutable to skills (CLAUDE.md §7); changes require an **additive patch
> with HUMAN approval.** This is a PROPOSAL in `governanceReviews/`; **NOT** folded by any AI action. On
> approval, a human folds it as `generatedDocs/Doc-4C_BuyerProfileAuditToken_Patch_v1.0.2.md` and registers
> it in `00_AUTHORITY_MAP.md`.
>
...
> to *serialization* touches **this** patch, never reopens rank-0 Doc-2.
...
together). Frozen Doc-4C text not edited in place. **DRAFT — awaits HUMAN approval; not folded by AI.***
