...
> cycle CLOSED; artifact text gate-confirmed same day).** The individual-ADR corpus copy
> (`generatedDocs/ADR-024_Canonical_Vendor_Subdomain_URLs.md`) is carried alongside per the ADR-021
> precedent — the ADR Compendium itself is untouched (rank 1; Compendium-v2 consolidation deferred, human
> re-freeze). Ruling record: `governanceReviews/BOARD-PACKET-CANONICAL-VENDOR-SUBDOMAIN_v1.0.md`. This file
> stays the provenance copy.
