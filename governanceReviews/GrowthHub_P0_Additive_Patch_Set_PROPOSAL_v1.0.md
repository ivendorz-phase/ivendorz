...
|---|---|---|
| `Doc-2_Patch_v1.0.9` | Doc-2 v1.0.8 | 2 entities (§10.2), 2 machines (§5), §7 slug `can_manage_growth_invites`, 2 §8 events, 2 §9 audit actions |
...
| `Doc-7E_GrowthHub_Patch_v1.0.1` | Doc-7E | Growth Hub surface |
...
## B8 · Doc-7E → `Doc-7E_GrowthHub_Patch_v1.0.1`
