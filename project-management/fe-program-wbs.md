...
| FE-VEN-09 Trust Center | Trust | P1 | M | High | — | P-VND-28 | READY(build) — `ESC-7G-SCORE-DISPLAY`/`ESC-7B-TRUSTSCORE` RULED 2026-07-03 (Trust Score band+numeric+badges+factors, any public-facing surface, no corpus patch; Performance stays band-only); WP card pending kickoff |
