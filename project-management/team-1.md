...
| P-ACC-15 | Notification preferences | P2 | Ready | 🟡 In Progress | Building — M6 channel/type switch grid (Doc-5H prefs; self); channels grounded in M6 (in-app/email now; SMS/WhatsApp deferred per spec Future); notification types grounded in frozen M6 catalog (not coined); accessible toggles (channel+type labeled, not colour-only); save bar; honest interim |
