...
| P-AUTH-03 | Org setup (post-signup) | P0 | Ready | 🔵 | Ready for Review — presentation-only 2-step wizard; binds `create_organization` (frozen `name` only; participation = intent, `[ESC-7-API]`, not sent) |
